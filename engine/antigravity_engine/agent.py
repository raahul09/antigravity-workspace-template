...
from antigravity_engine.tools.openai_proxy import call_openai_chat
...
class GeminiAgent:
    ...
    def _initialize_mcp(self) -> None:
        ...
        try:
            ...
            from antigravity_engine.tools.mcp_tools import _set_mcp_manager
        ...
        for tool_file in tools_dir.glob("*.py"):
            ...
            try:
                ...
                spec = importlib.util.spec_from_file_location(
                    f"antigravity_engine.tools.{module_name}", tool_file
                )
                if spec and spec.loader:
                    ...
                    for name, obj in inspect.getmembers(module, inspect.isfunction):
                        ...
                        if (
                            ...
                            and obj.__module__ == f"antigravity_engine.tools.{module_name}"
                        ):
                            tools[name] = obj
